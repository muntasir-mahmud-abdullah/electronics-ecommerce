...
import { ArrowUpRight, DollarSign, Package, ShoppingBag, AlertCircle } from "lucide-react";
    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          ...
          <p className="text-3xl font-bold text-orange-600">{lowStockVariants}</p>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
          ...
          <Link href="/admin/orders" className="text-sm text-[#00D4E8] font-semibold hover:underline flex items-center">
